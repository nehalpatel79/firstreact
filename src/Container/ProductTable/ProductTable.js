...
const ProductTable = () => {
  ...
  const filteredData = () => {
    // -------------  catagory ma data filter  ----------------------------
    const categorisedData = category
      ? data.filter((v) => v.category === category)
      : data;

    //  ------------   data serach ---------------------------------------
    const serachedData = categorisedData.filter(
      (v) =>
    ...
    //  ------------   sort data ---------------------------------------
    let ans = [...serachedData];
    if (short === "az") {
      ans.sort((a, b) => a.title.localeCompare(b.title));
    } else if (short === "za") {
      ans.sort((a, b) => b.title.localeCompare(a.title));
  ...
  const pdata = pagination();
  

  const heandsortseach = (event) => {
